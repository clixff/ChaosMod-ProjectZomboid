EffectSpawnGrieferWizard = ChaosEffectBase:derive("EffectSpawnGrieferWizard", "spawn_griefer_wizard")

function EffectSpawnGrieferWizard:OnStart()
    ChaosEffectBase:OnStart()
    print("[EffectSpawnGrieferWizard] OnStart" .. tostring(self.effectId))
