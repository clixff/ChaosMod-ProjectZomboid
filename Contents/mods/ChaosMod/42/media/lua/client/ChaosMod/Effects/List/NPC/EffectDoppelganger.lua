EffectDoppelganger = ChaosEffectBase:derive("EffectDoppelganger", "effect_doppelganger")

function EffectDoppelganger:OnStart()
    ChaosEffectBase:OnStart()
    print("[EffectDoppelganger] OnStart" .. tostring(self.effectId))
    ...
    local newZombies = ChaosZombie.SpawnZombieAt(x2, y2, z2, 1, "Tourist", femaleChance)
