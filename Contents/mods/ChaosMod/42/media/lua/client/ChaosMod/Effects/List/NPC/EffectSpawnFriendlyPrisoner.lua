EffectSpawnFriendlyPrisoner = ChaosEffectBase:derive("EffectSpawnFriendlyPrisoner", "spawn_friendly_prisoner")

function EffectSpawnFriendlyPrisoner:OnStart()
    ChaosEffectBase:OnStart()
    print("[EffectSpawnFriendlyPrisoner] OnStart" .. tostring(self.effectId))
    ...
    local newZombies = ChaosZombie.SpawnZombieAt(x2, y2, z2, 1, "Inmate", 0)
