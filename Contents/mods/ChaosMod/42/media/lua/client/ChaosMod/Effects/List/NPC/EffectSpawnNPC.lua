---@class EffectSpawnNPC : ChaosEffectBase
EffectSpawnNPC = ChaosEffectBase:derive("EffectSpawnNPC", "spawn_npc")

function EffectSpawnNPC:OnStart()
    ChaosEffectBase:OnStart()
    print("[EffectSpawnNPC] OnStart" .. tostring(self.effectId))
    ...
    local newZombies = ChaosZombie.SpawnZombieAt(x2, y2, z2, 1, "Tourist", 0)
