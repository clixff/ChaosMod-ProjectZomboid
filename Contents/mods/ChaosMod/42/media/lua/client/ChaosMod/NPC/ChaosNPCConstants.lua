...
CHAOS_NPC_GIFT_ITEM_COOLDOWN_MS = 150000
-- CHAOS_NPC_GIFT_ITEM_COOLDOWN_MS = 10000
CHAOS_NPC_GIFT_ITEM_MAX_DIST = 2.0
...
CHAOS_NPC_PANIC_TRIGGER_DIST = 1.6
CHAOS_NPC_PANIC_THRESHOLD_UNARMED = 2
CHAOS_NPC_PANIC_THRESHOLD_ARMED = 3
CHAOS_NPC_PANIC_FLEE_MIN_RADIUS = 10
CHAOS_NPC_PANIC_FLEE_MAX_RADIUS = 30
CHAOS_NPC_PANIC_FLEE_MAX_TRIES = 20
CHAOS_NPC_PANIC_FLEE_SAFE_RADIUS = 4.0
CHAOS_NPC_PANIC_DURATION_MS = 10000
CHAOS_NPC_PANIC_COOLDOWN_MS = 3000
CHAOS_NPC_PANIC_CHECK_INTERVAL_MS = 200
CHAOS_NPC_PANIC_LOW_HEALTH_THRESHOLD = 0.6
CHAOS_NPC_PANIC_TAG = "panic"

CHAOS_NPC_PEDESTRIAN_PAUSE_MIN_MS = 2000
CHAOS_NPC_PEDESTRIAN_PAUSE_MAX_MS = 8000
