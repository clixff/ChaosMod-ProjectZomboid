---@class EffectReplaceFoodWithDeadRats : ChaosEffectBase
EffectReplaceFoodWithDeadRats = ChaosEffectBase:derive("EffectReplaceFoodWithDeadRats", "replace_food_with_dead_rats")

local RADIUS = 60
local REPLACEMENT_ITEM = "Base.DeadRat"
...
function EffectReplaceFoodWithDeadRats:OnStart()
    ...
    local msg = string.format(ChaosLocalization.GetString("misc", "food_replaced_with_dead_rats"), imgCode, totalReplaced)
